...
**OPEN — founder.** Nobody knows who produced the live variants or whether
quality was lost. Increment 7 re-encodes all images from the repo originals
anyway, which supersedes the live variants and makes this moot *provided*
increment 7's output is at least as small and at least as good. If increment 7
lands first, this closes automatically.
